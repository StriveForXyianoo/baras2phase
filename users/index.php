...
<head>
  ...
  *:focus {
  ...
  .bg-illustration {
    ...
    height: 100vh;
    width: 1194px;
    background: url("style/background.jpg") no-repeat center center scroll;
  ...
  @media only screen and (max-width: 1024px) {
    ...
    .bg-illustration {
      float: none;
      background: url("style/background.jpg") center center;
      background-size: cover;
...
<div class="parent clearfix">
    <div class="bg-illustration">
      <img src="images/bpp2nhs.png" alt="logo">
    ...
    <div class="login">
      <div class="container">
        ...
        <div class="login-form">
          <form action="controllers/login" method="POST" id="login-form">
